...
from slam_scripts.utils import load_sdf_with_namespace, create_namespaced_bridge_yaml
...
def generate_launch_description():
    ...
    default_world_path = os.path.join(pkg_turtlebot3_gazebo, 'worlds', 'custom_empty.world')
