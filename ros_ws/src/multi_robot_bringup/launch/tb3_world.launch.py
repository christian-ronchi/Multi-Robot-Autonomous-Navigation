...
def generate_launch_description():
    ...
    world_path = LaunchConfiguration('world', default=os.path.join(pkg_turtlebot3_gazebo, 'worlds', 'turtlebot3_dqn_stage1.world'))

    declare_world_arg = DeclareLaunchArgument(
        'world',
        default_value=os.path.join(pkg_turtlebot3_gazebo, 'worlds', 'turtlebot3_dqn_stage1.world'),
    ...
    # Initialize the main launch description and add Gazebo server/client
